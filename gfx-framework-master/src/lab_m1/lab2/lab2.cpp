...
void Lab2::Init()
{
...

    {
        vector<VertexFormat> vertices
        {
            ...
            // coordinates (x, y, z) varfuri! + color + ?
            VertexFormat(glm::vec3(-1, -1, 3), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, -1,  3), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, 1,  1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, 1, 3), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  3), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
        };
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(2, 0, 0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 2, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 2), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(3, 0.5f, 0), glm::vec3(0.35f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(5, 0.5f, 0), glm::vec3(0.35f));

    // RenderMesh(meshes["cube_D"], shaders["VertexColor"], glm::vec3(7, 0.5f, 0), glm::vec3(0.35f));
