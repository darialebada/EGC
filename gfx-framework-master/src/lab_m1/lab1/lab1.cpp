...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    // Render the object
    RenderMesh(meshes[shape], glm::vec3(1, 0.5f, 0), glm::vec3(0.5f));
    ...
    RenderMesh(meshes["bunny"], glm::vec3(xb, yb, zb), glm::vec3(0.02f));

    RenderMesh(meshes["ball"], glm::vec3(x_ball, y_ball, z_ball), glm::vec3(size_ball));
}
